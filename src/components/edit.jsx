...
const Edit = ({ productToEdit = null }) => {
  ...
  const validationSchema = Yup.object({
    ...
    Famous: Yup.string(),
    Comment: Yup.string(),
    BuyCout: Yup.number().required("لطفا تعداد خرید را وارد کنید").positive().integer(),
  ...
  const handleSubmit = async (values, { setSubmitting, resetForm }) => {
    try {
        ...
        formData.append("BuyCout", values.BuyCout);
      ...
      {({ setFieldValue }) => (
        ...
        <Form>
          ...
          <div style={{ marginLeft: "30px", marginRight: "30px" }}>
            ...
            <div className="d-flex flex-row mb-3 mt-5" style={{ textAlign: "right" }}>
            ...
            <div className="d-flex flex-row mb-3 mt-5">
              <div className="col-md-4" style={{ textAlign: "right" }}>
                <label className="ml-2">عکس کالا</label>
                <input
                  name="ProductImg"
                  type="file"
                  accept="image/*"
